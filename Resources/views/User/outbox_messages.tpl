...
<input type="hidden" name="csrftoken" value="{insert name='csrftoken'}" />  
    ...
    <div class="list-group clearfix">
        <div class="list-group-item col-md-12" style="background: #F2F8FF;">
                    <div class="col-md-1"><i class="fa fa-upload"> </i> {$ictitle}</div>                   
        </div>
        ...
        <div class="list-group-item col-md-12 clearfix {if $messagesarray[message].seen == NULL} warning {/if}" {if $messagesarray[message].seen == NULL} style="background:#fcf0ba"{/if}>
                ...
                <div id="msgbody-{$messagesarray[message].id}" class="col-md-12 clear collapse" >
