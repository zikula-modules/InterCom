...
class InterCom_Controller_Admin extends Zikula_Controller
{
    ...
    public function main()
    {
        ...
        return $this->view->fetch('intercom_admin_main.htm');
    }
    ...
    public function modifyconfig()
    {
        ...
        $pnf = FormUtil::newForm('InterCom');

        // Return the output that has been generated by this function
        return $pnf->execute('intercom_admin_modifyconfig.htm', new InterCom_Form_Handler_Admin_ModifyConfig());
    }
    ...
    public function tools()
    {
        ...
        return $this->view->fetch('intercom_admin_tools.htm');
    }
