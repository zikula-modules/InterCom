 ...
 *
 * == Carsten Volmer -- 9/14/08 ==
 * mod: moved Ajax.Request back to search on every new input
 *
 * == Carsten Volmer -- 11/17/08 ==
 * synched with http://github.com/lorenjohnson/facebook-multiselect/commits/master/
 * mod: 05/07/08 Add search timeout to increase responsiveness to typing. 
  ...
  createInput: function($super,options) {
    ...
    input.observe('keyup',function(e) {
      ...
      switch(e.keyCode) {
        ...
        break;
        default:
      if (!Object.isUndefined(this.options.get('fetchFile')) && input.value.length >= minCharsToStartSearch) {
