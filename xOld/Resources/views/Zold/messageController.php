...
class messageController {
    ...
    public function replyfrominbox() {
        ...
        $message = ModUtil::apiFunc('InterCom', 'user', 'getmessages', array('boxtype' => 'msg_inbox',
                    'msg_id' => $msg_id));
    ...
    public function sendreply() {
        ...
        $replytomessage = ModUtil::apiFunc('InterCom', 'user', 'getmessages', array('boxtype' => $boxtype,
                    'msg_id' => $replyto));
        //$message .= "[addsig]";
        ...
        if ($replyto <> 0) {
            ModUtil::apiFunc('InterCom', 'user', 'mark_replied', array('msg_id' => $replyto));
        }

        ModUtil::apiFunc('InterCom', 'user', 'store_message', array('from_userid' => $from_uid,
            ...
            'msg_outbox' => '1',
            'msg_stored' => '0'));
        ModUtil::apiFunc('InterCom', 'user', 'autoreply', array('to_uid' => $replytomessage['from_userid'],
            'from_uid' => $from_uid,
            'subject' => $subject));
    ...
    public function sendforward() {
        ...
        ModUtil::apiFunc('InterCom', 'user', 'store_message', array('from_userid' => $from_uid,
            ...
            'msg_outbox' => '1',
            'msg_stored' => '0'));
        ModUtil::apiFunc('InterCom', 'user', 'autoreply', array('to_uid' => $forwardto_uid,
            'from_uid' => $from_uid,
            'subject' => $subject));
    ...
    public function togglestatus() {
        ...
        $message = ModUtil::apiFunc('InterCom', 'user', 'getmessages', array('boxtype' => $boxtype,
                    'msg_id' => $msg_id));
