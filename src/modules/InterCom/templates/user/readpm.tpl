...
<div id="ic-readform" class="z-form">
    <fieldset>
        ...
        <div class="z-formrow">
            ...
            {/if}
            <span>
                <strong>{$message.uname|userprofilelink}</strong>
    ...
    <div class="z-formbuttons ic-buttons">
        {if $boxtype eq "inbox"}
        <a href="{modurl modname="InterCom" type="user" func="replyinbox" messageid=$message.msg_id}" title="{gt text='Reply'}">{img modname=core src=mail_reply.gif set=icons/extrasmall __alt="Reply" __title="Reply"} {gt text="Reply"}</a>
