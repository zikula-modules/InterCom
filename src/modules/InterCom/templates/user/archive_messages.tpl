        ...
        <div id="msg_listing">
            ...
            <dl id="msgheader-{$messagearray[message].msg_id}" class="msg_line {if $zaehlen is odd}odd{elseif $zaehlen is even}even{/if}">
                ...
                <dd id="msgicon{$messagearray[message].msg_id}" class="msg_icon clickable">
                    {img modname=core src="mail_generic.png" set="icons/extrasmall"  __title="read"}
                </dd>
                ...
                <dd class="msg_view"><a href="{modurl modname="InterCom" type="user" func="readarchive" messageid=$messagearray[message].msg_id}">{img modname=core src="demo.png" set="icons/extrasmall" __title="Read" }</a></dd>
            </dl>
