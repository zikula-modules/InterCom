...
{formvalidationsummary}
    ...
    <fieldset>
        ...
        <div class="">
            ...
            <p class="help-block">{gt text="Notice: Here you can specify whether or not you want to be notified via an e-mail message each time you receive a private message in your private messaging mailbox on the site."}</p>
        </div>
    </fieldset>
    {/if}
    ...
    <fieldset>
        ...
        <div class="z-formrow">
            ...
            <p class="help-block">{gt text="Notice: Here you can specify whether or not you want an automatic response to be sent to the sender each time you receive a private message (possibly useful when you are on holiday, for instance)."}</p>
        </div>
        <div id="">
            <div class="">
